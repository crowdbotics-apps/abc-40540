"""
Django settings for abc_40540 project.
...
WSGI_APPLICATION = 'abc_40540.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abc_40540 API",
    "DESCRIPTION": "API documentation for abc_40540 App",
    "VERSION": "v1",
}
